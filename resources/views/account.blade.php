                    ...
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
                        ...
                        <li class="mr-2" role="presentation">
                            <button
                                ...
                                aria-controls="profile" aria-selected="true">Change nick</button>
                        </li>
                ...
                <div id="accountTable">
                    <div class="p-4 rounded-lg dark:bg-gray-800" id="name" role="tabpanel"
                        ...
                        <form method="post" action="{{route('change_name')}}">
                            @csrf
                            <div class="mb-6">
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="name-input">{{__('Name')}}</label>
